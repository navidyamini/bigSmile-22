...
import polito.mad.mobiledeviceapplication.chat.ImageMessage
import polito.mad.mobiledeviceapplication.chat.MessageType
...
class ChatActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar?.title = intent.getStringExtra(AppConstants.USER_NAME_R)

        val otherUserId = intent.getStringExtra(AppConstants.USER_ID_R)
